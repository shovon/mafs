import { SideMap, SideSet } from "./SideMap"
...
const pointEquals = ([x1, y1]: Point2D, [x2, y2]: Point2D) => x1 === x2 && y1 === y2

const sideEquals = ([s1p1, s1p2]: [Point2D, Point2D], [s2p1, s2p2]: [Point2D, Point2D]): boolean =>
  pointEquals(s1p1, s2p1) && pointEquals(s1p2, s2p2)
